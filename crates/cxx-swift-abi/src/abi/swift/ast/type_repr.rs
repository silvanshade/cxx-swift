...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "type_repr"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/TypeRepr.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::type_repr";
    let cxx_name = "TypeRepr";
    let rust_name = "TypeRepr";

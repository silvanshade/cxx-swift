...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "ast_walker"];
    let path_descendants = vec!["parent_ty", "pre_walk_result_expr"];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/ASTWalker.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::ast_walker";
    let cxx_name = "ASTWalker";
    let rust_name = "AstWalker";

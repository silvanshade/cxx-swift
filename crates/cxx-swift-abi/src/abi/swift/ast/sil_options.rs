...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "sil_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/SILOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::sil_options";
    let cxx_name = "SILOptions";
    let rust_name = "SilOptions";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "identifier", "small_vector"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/Identifier/SmallVector.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::identifier::small_vector";

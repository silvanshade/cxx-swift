...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "dependency_tracker"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/DependencyTracker.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::dependency_tracker";
    let cxx_name = "DependencyTracker";
    let rust_name = "DependencyTracker";

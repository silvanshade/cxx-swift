...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "ast_walker_base"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/ASTWalkerBase.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::ast_walker_base";
    let cxx_name = "ASTWalkerBase";
    let rust_name = "AstWalkerBase";

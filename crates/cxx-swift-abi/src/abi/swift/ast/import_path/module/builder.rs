...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "import_path", "module", "builder"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/ImportPath/Module/Builder.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::import_path::module::builder";
    let cxx_name = "Builder";
    let rust_name = "Builder";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "import_path", "module"];
    let path_descendants = vec!["builder"];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/ImportPath/Module.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::import_path::module";
    let cxx_name = "Module";
    let rust_name = "Module";

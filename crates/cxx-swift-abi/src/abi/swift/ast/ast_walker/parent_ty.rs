...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "ast_walker", "parent_ty"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/ASTWalker/ParentTy.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::ast_walker::parent_ty";
    let cxx_name = "ParentTy";
    let rust_name = "ParentTy";

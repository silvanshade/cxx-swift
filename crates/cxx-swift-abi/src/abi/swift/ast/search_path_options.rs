...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "ast", "search_path_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/AST/SearchPathOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::ast::search_path_options";
    let cxx_name = "SearchPathOptions";
    let rust_name = "SearchPathOptions";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "basic", "source_loc"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/Basic/SourceLoc.hxx";
    let cxx_namespace = "cxx_swift::swift::basic::source_loc";
    let cxx_name = "SourceLoc";
    let rust_name = "SourceLoc";

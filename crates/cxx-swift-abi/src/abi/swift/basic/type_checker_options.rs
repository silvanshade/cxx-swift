...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "basic", "type_checker_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/Basic/TypeCheckerOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::basic::type_checker_options";
    let cxx_name = "TypeCheckerOptions";
    let rust_name = "TypeCheckerOptions";

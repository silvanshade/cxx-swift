...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "basic", "source_manager"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/Basic/SourceManager.hxx";
    let cxx_namespace = "cxx_swift::swift::basic::source_manager";
    let cxx_name = "SourceManager";
    let rust_name = "SourceManager";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "basic", "clang_importer_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/Basic/ClangImporterOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::basic::clang_importer_options";
    let cxx_name = "ClangImporterOptions";
    let rust_name = "ClangImporterOptions";

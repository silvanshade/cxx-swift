...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "basic", "lang_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/Basic/LangOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::basic::lang_options";
    let cxx_name = "LangOptions";
    let rust_name = "LangOptions";

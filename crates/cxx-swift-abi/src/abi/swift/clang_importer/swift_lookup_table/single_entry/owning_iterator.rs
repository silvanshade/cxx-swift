...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    ...
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SwiftLookupTable/SingleEntry/OwningIterator.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::swift_lookup_table::single_entry::owning_iterator";
    let cxx_name = "SwiftLookupTableSingleEntryOwningIterator";
    let rust_name = "SwiftLookupTableSingleEntryOwningIterator";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    ...
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SwiftLookupTable/SingleEntry/SmallVectorImpl.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::swift_lookup_table::single_entry::small_vector_impl";

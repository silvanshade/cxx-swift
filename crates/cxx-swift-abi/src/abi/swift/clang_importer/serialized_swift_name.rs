...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "serialized_swift_name"];
    let path_descendants = vec!["owning_iterator"];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SerializedSwiftName.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::serialized_swift_name";
    let cxx_name = "SerializedSwiftName";
    let rust_name = "SerializedSwiftName";

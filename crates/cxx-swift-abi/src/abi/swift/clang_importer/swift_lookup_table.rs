...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "swift_lookup_table"];
    let path_descendants = vec!["single_entry"];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SwiftLookupTable.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::swift_lookup_table";
    let cxx_name = "SwiftLookupTable";
    let rust_name = "SwiftLookupTable";

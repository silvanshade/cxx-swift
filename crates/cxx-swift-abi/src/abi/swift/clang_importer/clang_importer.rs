...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "clang_importer"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/ClangImporter.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::clang_importer";
    let cxx_name = "ClangImporter";
    let rust_name = "ClangImporter";

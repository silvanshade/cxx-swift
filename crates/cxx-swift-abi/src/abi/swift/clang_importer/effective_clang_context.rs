...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "effective_clang_context"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/EffectiveClangContext.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::effective_clang_context";
    let cxx_name = "EffectiveClangContext";
    let rust_name = "EffectiveClangContext";

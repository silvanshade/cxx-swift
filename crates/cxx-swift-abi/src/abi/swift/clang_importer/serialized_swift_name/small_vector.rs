...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "serialized_swift_name", "small_vector"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SerializedSwiftName/SmallVector.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::serialized_swift_name::small_vector";
    let cxx_name = "SmallVector";
    let rust_name = "SmallVector";

...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "serialized_swift_name", "small_vector_impl"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SerializedSwiftName/SmallVectorImpl.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::serialized_swift_name::small_vector_impl";
    let cxx_name = "SmallVectorImpl";
    let rust_name = "SmallVectorImpl";

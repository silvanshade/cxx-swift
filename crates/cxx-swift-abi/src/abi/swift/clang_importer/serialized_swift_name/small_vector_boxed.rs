...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "clang_importer", "serialized_swift_name", "small_vector_boxed"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/ClangImporter/SerializedSwiftName/SmallVectorBoxed.hxx";
    let cxx_namespace = "cxx_swift::swift::clang_importer::serialized_swift_name::small_vector_boxed";
    let cxx_name = "SmallVectorBoxed";
    let rust_name = "SmallVectorBoxed";

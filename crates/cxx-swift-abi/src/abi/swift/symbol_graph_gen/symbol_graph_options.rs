...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["swift", "symbol_graph_gen", "symbol_graph_options"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/swift/SymbolGraphGen/SymbolGraphOptions.hxx";
    let cxx_namespace = "cxx_swift::swift::symbol_graph_gen::symbol_graph_options";
    let cxx_name = "SymbolGraphOptions";
    let rust_name = "SymbolGraphOptions";

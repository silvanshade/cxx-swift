...
fn artifact_info() -> ::cxx_memory_abi::CxxAbiArtifactInfo {
    let path_components = vec!["llvm", "adt", "small_vector", "swift", "ast", "identifier"];
    let path_descendants = vec![];
    let cxx_include = "cxx-swift-abi/cxx/include/llvm/ADT/SmallVector/swift/AST/Identifier.hxx";
    let cxx_namespace = "cxx_llvm::llvm::adt::small_vector::swift::ast::identifier";

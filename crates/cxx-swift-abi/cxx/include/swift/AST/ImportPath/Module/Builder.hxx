...
using Builder = ::swift::ImportPath::Module::Builder;
using F = Builder;
...
static inline auto
cxx_placement_new_from_identifier(F* This [[clang::lifetimebound]], ::swift::Identifier name) noexcept -> void
{
...
[[gnu::always_inline]] [[gnu::const]]
static inline auto
get(F const& This [[clang::lifetimebound]]) noexcept -> ::swift::ImportPath::Module
{
  return This.get();
}

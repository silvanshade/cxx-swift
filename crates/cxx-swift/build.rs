...
fn process_cxx() -> BoxResult<()> {
    ...
    let rust_source_files: &[&str] = &[
        ...
        "src/gen/llvm/adt/small_vector_impl/swift/ast/identifier.rs",
        "src/gen/llvm/adt/small_vector/swift/ast/identifier.rs",
        ...
        "src/gen/swift/clang_importer/serialized_swift_name/owning_iterator.rs",
        "src/gen/swift/clang_importer/swift_lookup_table.rs",
        "src/gen/swift/clang_importer/swift_lookup_table/single_entry.rs",
        "src/gen/swift/clang_importer/swift_lookup_table/single_entry/owning_iterator.rs",

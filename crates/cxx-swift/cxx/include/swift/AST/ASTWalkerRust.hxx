...
{
  return cxx_memory::abi::cxx_placement_new(This, ::std::forward<rust::Box<ASTWalkerDyn>>(ast_walker_dyn));
}
...
namespace cxx_swift::swift::ast::ast_walker_rust {
static_assert(
  cxx_memory::abi::cxx_abi_align<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_abi_align<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_abi_size<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_abi_size<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_copy_constructible<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_copy_constructible<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_move_constructible<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_move_constructible<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_destructible<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_destructible<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_trivially_copyable<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_trivially_copyable<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_trivially_movable<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_trivially_movable<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
static_assert(
  cxx_memory::abi::cxx_is_trivially_destructible<ASTWalkerRustTemplate<ASTWalkerDyn>>() ==
  cxx_memory::abi::cxx_is_trivially_destructible<ASTWalkerRustTemplate<ASTWalkerDynProxy>>()
);
} // namespace cxx_swift::swift::ast::ast_walker_rust

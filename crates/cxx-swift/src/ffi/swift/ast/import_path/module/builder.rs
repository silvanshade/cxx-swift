...
pub use crate::auto::swift::ast::import_path::module::builder::Builder;

impl<'ctx> Builder<'ctx> {
    #[inline]
    pub fn new() -> impl moveref::New<Output = Builder<'ctx>> {
        Self::default_new()
    }

    #[inline]
    pub fn from<Data>(data: Data) -> impl moveref::New<Output = Builder<'ctx>>
    where
